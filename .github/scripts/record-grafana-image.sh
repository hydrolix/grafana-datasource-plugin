...
#
# Env: GRAFANA_VERSION (required), GRAFANA_REPO, CONTAINER, LUXON,
...
# Read the image from the container rather than rebuilding the name, which
# would silently drift from the `image:` line in e2e-docker-compose.yml.
