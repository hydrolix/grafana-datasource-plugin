...
// ClickhouseContainer contains container link and all related useful information.
...
// NewClickhouseContainer instantiates CH container.
func NewClickhouseContainer(ctx context.Context, username, password string) (*ClickhouseContainer, error) {
